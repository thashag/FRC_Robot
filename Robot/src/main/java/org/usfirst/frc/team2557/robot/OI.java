...
//
	...
	//Could use an array here if natural ordering.
...
//        driverRJB = new JoystickButton(driver, 10);
    	...
    	driver 		= new Joystick(0);
	//i starts at zero and goes to 11 one digit at a time.
	for(int i = 0; i < buttons.length; i++){
		buttons[i] = new JoystickButton(driver, i + 1);
	}
...
//     	button12 	= new JoystickButton(driver, 12);
        ...
        //button12 -> button[11] due to 0 - 11 indexes
	buttons[11].whileHeld(new MacroRecordCommand("/home/lvuser/test.autonomous"));
        //button11 -> button[10] due to 0 - 11 indexes
	buttons[10].whileHeld(new MacroPlayCommand("/home/lvuser/test.autonomous"));
